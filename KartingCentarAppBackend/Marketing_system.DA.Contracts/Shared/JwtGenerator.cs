...
namespace Marketing_system.DA.Contracts.Shared
{
    ...
    {
        private readonly string _key = Environment.GetEnvironmentVariable("JWT_KEY") ?? "karting-centar-application_secret_key";
        private readonly string _issuer = Environment.GetEnvironmentVariable("JWT_ISSUER") ?? "karting-centar";
        private readonly string _audience = Environment.GetEnvironmentVariable("JWT_AUDIENCE") ?? "karting-centar-front.com";
